...
cityscapes_palette = [128, 64, 128, 244, 35, 232, 70, 70, 70, 102, 102, 156, 190, 153, 153, 153, 153, 153, 250, 170, 30,
                      ...
                      70,
                      0, 60, 100, 0, 80, 100, 0, 0, 230, 119, 11, 32]  #3个一组表示1类物体的颜色
...
ddd17_palette = [128, 64, 128, 70, 70, 70, 220, 220, 0, 107, 142, 35, 220, 20, 60, 0, 0, 142]

dsec_palette = [0, 0, 0, 70 ,70, 70, 190, 153, 153, 220, 20, 60, 153, 153, 153, 128, 64, 128,
                244, 35, 232, 107, 142, 35, 0,  0, 142, 102, 102, 156, 220, 220, 0]  
...
def ddd17_colorize_mask(mask):
    # mask: numpy array of the mask
    new_mask = Image.fromarray(mask.astype(np.uint8)).convert('P')
    new_mask.putpalette(ddd17_palette)
